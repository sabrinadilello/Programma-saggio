...
const programData: ProgramSectionData[] = [
  ...
  },
  {
    ...
    choreographies: [
      { title: 'OGGI COME OGGI: CALYPSO – ANALOG SOL', courses: "Corso: contemporaneo 3", choreographer: "Coreografia: Rozen Corbel", description: "La città corre: tra folla, silenzi e relazioni che si sfiorano senza toccarsi." },
