...
const programData: Omit<ProgramSectionData, 'image'>[] = [
  // --- MODIFICA 2: Rimuoviamo le immagini dai dati statici, le aggiungeremo dinamicamente ---
  {
    ...
    choreographies: [
      ...
      { title: "CRAZY – INTERPRETI VARI", courses: "Corso: Hip Hop 2", choreographer: "Coreografia: Andre Sgarra", description: "Sono diventato matto... ma lascia che ti dica una cosa: nella mia follia ho trovato la mia verità." },
    ]
  },
  {
    title: '🎬 SECONDO TEMPO',
